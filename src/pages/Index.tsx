...
const Index = () => {
  const customServices = [
    { title: "Desarrollo Web", description: "Sitios web personalizados con diseño responsive", category: "A la medida" },
    ...
    { title: "E-commerce", description: "Tiendas en línea personalizadas con pasarelas de pago", category: "A la medida" },
    { title: "Base de Datos", description: "Diseño e implementación de bases de datos optimizadas", category: "A la medida" },
    { title: "Diseño UX/UI", description: "Interfaces de usuario intuitivas y experiencias memorables", category: "A la medida" },
  ];

  const establishedServices = [
    { title: "Sistema de Inventario", description: "Gestión eficiente de inventario para cualquier negocio", category: "Establecido" },
    { title: "Sistema de Help-Desk", description: "Plataforma de soporte al cliente y gestión de tickets", category: "Establecido" },
  ];

  const inDevelopmentServices = [
    { title: "Contabilidad", description: "Sistema de contabilidad para empresas (próximamente)", category: "En desarrollo" },
    { title: "Nómina", description: "Gestión de nóminas y recursos humanos (próximamente)", category: "En desarrollo" },
    { title: "Hospitales", description: "Software para gestión hospitalaria (próximamente)", category: "En desarrollo" },
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary/90 to-primary text-primary-foreground">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl mb-10 text-primary-foreground/80 max-w-3xl mx-auto animate-fade-up" style={{ animationDelay: "200ms" }}>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
            <Card className="text-center hover:shadow-md transition-all">
              ...
              <CardFooter>
                <Link to="/request-form" className="w-full">
                  <Button variant="outline" className="w-full">Prefiero llamada</Button>
                </Link>
              </CardFooter>
            </Card>
            ...
            <Card className="text-center hover:shadow-md transition-all">
              ...
              <CardFooter>
                <Link to="/request-form" className="w-full">
                  <Button variant="outline" className="w-full">Prefiero WhatsApp</Button>
                </Link>
              </CardFooter>
            </Card>
          </div>
